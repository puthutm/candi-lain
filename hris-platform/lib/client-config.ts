/**
 * Client-safe configuration for HRIS Platform.
 *
...
export const APP_NAME = read("NEXT_PUBLIC_APP_NAME", "HRIS");
...
export const SSO_CLIENT_ID = read("NEXT_PUBLIC_SSO_OAUTH_CLIENT_ID", "hris-platform");
export const SSO_CALLBACK_URL = read("NEXT_PUBLIC_SSO_OAUTH_CALLBACK_URL", "http://localhost:3006/api/auth/callback");
