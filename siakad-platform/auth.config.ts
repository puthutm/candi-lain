  ...
  try {
    ...
    const response = await fetch(url, {
      ...
      body: new URLSearchParams({
        ...
        client_id: env.SSO_OAUTH_CLIENT_ID || "siakad-platform",
...
/**
 * SIAKAD Platform Auth.js / NextAuth configuration.
 */
export const authConfig: Parameters<typeof NextAuth>[0] = {
  ...
  cookies: {
    sessionToken: { name: "siakad.authjs.session-token", options: { path: "/", sameSite: "lax", secure: false, httpOnly: true } },
    callbackUrl: { name: "siakad.authjs.callback-url", options: { path: "/", sameSite: "lax", secure: false, httpOnly: true } },
    csrfToken: { name: "siakad.authjs.csrf-token", options: { path: "/", sameSite: "lax", secure: false, httpOnly: true } },
    pkceCodeVerifier: { name: "siakad.authjs.pkce.code_verifier", options: { path: "/", sameSite: "lax", secure: false, httpOnly: true } },
    state: { name: "siakad.authjs.state", options: { path: "/", sameSite: "lax", secure: false, httpOnly: true } },
    nonce: { name: "siakad.authjs.nonce", options: { path: "/", sameSite: "lax", secure: false, httpOnly: true } }
  },
