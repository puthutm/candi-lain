...
export const APP_NAME = read("NEXT_PUBLIC_APP_NAME", "Bank Konten Akademik");
...
export const SSO_CLIENT_ID = read("NEXT_PUBLIC_SSO_OAUTH_CLIENT_ID", "bank-konten-platform");
export const SSO_CALLBACK_URL = read("NEXT_PUBLIC_SSO_OAUTH_CALLBACK_URL", "http://localhost:3007/api/auth/callback");
