      ...
      <main className="flex-1 p-8 overflow-y-auto max-w-6xl mx-auto w-full space-y-12">
        ...
        <section>
          <header className="flex items-center justify-between pb-6 border-b border-white/10">
            <div>
              <h1 className="text-3xl font-bold tracking-tight">Data Reference Categories</h1>
              <p className="text-slate-400 text-sm mt-1">Manage global master data tables used across enterprise apps.</p>
            </div>
          </header>
              ...
              categories.map((cat) => (
                ...
                >
                  ...
                  <div className="mt-6 pt-4 border-t border-white/5 flex justify-between items-center text-xs">
                    ...
                    <Link
                      href={`/admin/reference/categories/${cat.code}`}
        ...
        <section>
          <header className="flex items-center justify-between pb-6 border-b border-white/10">
            <div>
              <h2 className="text-2xl font-bold tracking-tight">Organizational Hierarchy</h2>
              <p className="text-slate-400 text-sm mt-1">Define units (companies, divisions, departments) mapping structures.</p>
            </div>
          </header>
